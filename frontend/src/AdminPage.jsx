    ...
    <div style={{ maxWidth: 1400, margin: '0 auto', padding: '24px 24px 40px' }}>
      ...
      >
        <Text type="secondary" style={{ display: 'block', marginBottom: 8, fontSize: 13 }}>
          삭제 사유를 입력해야 삭제할 수 있습니다 — 나중에 관리자 전용 "삭제 보고서" 화면에서 확인할 수 있습니다.
        </Text>
        <Input.TextArea
          autoFocus
        ...
        />
        <div style={{ textAlign: 'right', fontSize: 12, color: 'rgba(0,0,0,0.45)', marginTop: 2 }}>{deleteReason.length}/300</div>
      </Modal>
